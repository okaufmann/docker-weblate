...
# Mail Server
EMAIL_HOST = USER_SETTINGS['EMAIL_HOST']

# User to auth on Mailserver
EMAIL_HOST_USER = USER_SETTINGS['EMAIL_HOST_USER']

# Password for User
EMAIL_HOST_PASSWORD = USER_SETTINGS['EMAIL_HOST_PASSWORD']

# Mailserver Port (Default:25)
EMAIL_PORT = USER_SETTINGS['EMAIL_PORT']
